...
function loop() {
    ...
    if(window.innerWidth<970){
        ctx.moveTo(0,c.height/2+left)
        ctx.bezierCurveTo(c.width/2,c.height/2+left-50,c.width/2,c.height/2+right+50,c.width,c.height/2+right)
